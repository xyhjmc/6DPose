...
def parse_args():
    ...
    p.add_argument("--out-dir", required=False, default="/home/xyh/PycharmProjects/6DPose/data/linemod_pvnet/driller_all_crop128",help="output directory for .npz files")
    ...
    p.add_argument("--crop-size", type=int, default=128, help="if set, crop ROI to a fixed square resolution (e.g., 256)")
